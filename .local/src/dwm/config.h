...
static char *fonts[]          = { "monospace:size=14:antialias=true:autohint=true", "JoyPixels:pixelsize=14:antialias=true:autohint=true"  };
/*
static char *fonts[] = {
    "monospace:size=14",
...
static const Key keys[] = {
    ...
    {MODKEY, XK_BackSpace, spawn, {.v = (const char *[]){"syscat", NULL}}},
    {MODKEY | ShiftMask, XK_BackSpace, spawn, {.v = (const char *[]){"syscat", NULL}}},
    ...
    {MODKEY | ShiftMask, XK_q, spawn, {.v = (const char *[]){"syscat", NULL}}},
    ...
    {MODKEY, XK_c, spawn, {.v = (const char *[]){"nemo", NULL}}},
    ...
    /* { 0, XF86XK_PowerOff,		spawn,		{.v = (const char*[]){ "syscat", NULL } } }, */
